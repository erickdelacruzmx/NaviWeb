<?php
// La sesión y config_db ya fueron iniciados por el controlador
...
<body class="min-h-screen bg-gradient-to-b from-gray-50 to-white" style="font-family: Poppins, system-ui, -apple-system, Segoe UI, Roboto, sans-serif;">
    ...
    <nav class="flex flex-col lg:flex-row items-center justify-between px-4 md:px-8 xl:px-12 py-4 md:py-5 xl:py-6 bg-white shadow-md sticky top-0 z-50 gap-2 md:gap-0">
        ...
        <div class="flex items-center gap-4 xl:gap-5 2xl:gap-6">
            ...
            <a href="/NaviWeb/logout.php" class="text-red-500 hover:underline text-xs md:text-sm xl:text-base 2xl:text-lg focus:outline-none focus:ring-2 focus:ring-red-400 rounded"><i class="fas fa-sign-out-alt mr-1"></i>Salir</a>
        </div>
    </nav>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div class="bg-white rounded-2xl shadow p-6 lg:p-8">
                ...
                <div class="flex flex-wrap gap-2 md:gap-3">
                    ...
                    <a href="/NaviWeb/logout.php" class="px-3 md:px-4 py-2 md:py-3 rounded-xl bg-red-500 text-white hover:bg-red-600 transition focus:outline-none focus:ring-2 focus:ring-red-400"><i class="fas fa-sign-out-alt mr-2"></i>Salir</a>
                </div>
            </div>
        </section>
